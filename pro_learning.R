...
library("wordcloud")
png("wc_spam.png")
wordcloud(spam$text,min.freq=40,random.order=F, scale=c(5,0.1),colors=c("blue",'green',"yellow","red"))
dev.off()
png("wc_ham.png")
wordcloud(ham$text, min.freq=40,random.order=F, scale=c(5,0.1),colors=c('blue','green',"yellow","red"))
dev.off()
